...
class SessionManager extends ChangeNotifier {
  ...
  String? _phoneModel;
  String? _testerName;
  String _apiBaseUrl = "https://shaggiest-graciously-chantell.ngrok-free.dev";
  ...
  Future<bool> createSession(String phoneModel, String testerName) async {
    try {
      final response = await http
          .post(
            Uri.parse('$_apiBaseUrl/sessions/create'),
            body: {'phone_model': phoneModel, 'tester_name': testerName},
          )
